...
public class PetApi {
     ...
     * @param fileObject File object that needs to be uploaded to server(required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call uploadXMLFile(File fileObject, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
       
        Object localVarPostBody = null;
        		
        // create path and map variables
        String localVarPath = "/pet/upload";
        ...
        Map<String, Object> localVarFormParams = new HashMap<String, Object>();
        //add file object in Map
        localVarFormParams.put("file", fileObject);
     ...
     * upload file
     * 
     * @param fileObject Pet File object that needs uploaded (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void checkFileUpload(File fileObject) throws ApiException {
    	com.squareup.okhttp.Call call = uploadXMLFile(fileObject,  null, null);
